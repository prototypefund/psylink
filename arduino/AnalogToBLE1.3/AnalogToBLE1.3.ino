...
// 1. ArduinoBLE 1.2.1
// 2. Arduino_LSM9DS1 1.1.0 (if you use the original Arduino Nano 33 BLE (Sense), not "Rev2")
// 3. Arduino_BMI270_BMM150 1.2.0 (if you use Rev2 of the Arduino Nano 33 BLE (Sense))
//
// Other/newer versions will likely work as well.

// Feature flags
#define ARDUINO_REV2 true  // Set this to false if you use the original Arduino Nano 33 BLE (Sense), not Rev2
